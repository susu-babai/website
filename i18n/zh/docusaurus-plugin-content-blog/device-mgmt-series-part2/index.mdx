...
在上一篇文章中，我们为适应用户对边缘设备管理的需求，设计实现了基于物模型的设备管理 API。在此基础上，我们完善了 DMI 数据面的能力，提供边缘端处理设备数据的多种方式，让 KubeEdge 能够更灵活、标准化的管理边缘设备。本篇文章是系列文章的第二篇，将详细介绍 v1.15.0 版本在 DMI 数据面的一些工作。
...
![DMI 架构图](https://files.mdnice.com/user/46056/b13246f4-66b2-4f6c-a347-e43e87c9441c.png)
...
![DMI 数据面系统架构](https://files.mdnice.com/user/46056/737f61aa-7806-48c4-87ad-5b29f0531179.png)
